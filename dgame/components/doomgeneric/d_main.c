...
static void SetMissionForPackName(char *pack_name)
{
    ...
    I_Error("8"); //"Unknown mission pack name: %s", pack_name);
}
...
void D_IdentifyVersion(void)
{
    ...
    if (gamemission == none)
    {
        ...
        if (gamemission == none)
        {
            ...
            I_Error("9"); //"Unknown or invalid IWAD file.");
        }
    }
...
static void InitGameVersion(void)
{
    ...
    if (p)
    {
        ...
        if (gameversions[i].description == NULL) 
        {
            ...
            I_Error("10"); //Unknown game version '%s'", myargv[p+1]);
        }
    }
    else
    {
...
static void LoadIwadDeh(void)
{
    ...
    if (gameversion == exe_chex)
    {
        ...
        if (sep != NULL)
        {
            ...
            chex_deh = mem_alloc(chex_deh_len);
...
void D_DoomMain (void)
{
    ...
    if( iwadfile == NULL )
    {
        I_Error("11"); // "Game mode indeterminate.  No IWAD file was found.  Try\n"
