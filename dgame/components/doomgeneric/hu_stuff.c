...
const char* getPlayerNameByIdx( int idx ) {
...
static const char *mapnames_commercial[] =
{
    // DOOM 2 map names.
    HUSTR_1,
    HUSTR_2,
...
void HU_Ticker(void)
{
	...
	for (i=0 ; i<MAXPLAYERS; i++)
	{
		...
		else
		{
			...
			{
			    HUlib_addMessageToSText( &w_message, DEH_String(getPlayerNameByIdx(i)), w_inputbuffer[i].l.l );
