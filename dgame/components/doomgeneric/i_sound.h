...
{
    // used by ESP32 port to play pre-cached fx by id
    int fxID;
    ...
    // Maximum number of channels that the sound can be played on Heretic
    //int numchannels;

    // data used by the low level code
    void *driver_data; // will point to pcm 11025 kHz, 8 bit, mono
};
...
// This is low-level interface to play sound fx
...
// This is low-level interface used by the engine to play midi music
